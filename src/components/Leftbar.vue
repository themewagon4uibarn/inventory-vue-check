            ...
            <div class="h-100" data-simplebar>
                ...
                <div id="sidebar-menu">
                    ...
                    <ul id="side-menu">
                        ...
                        <li>
                            ...
                            <div class="collapse" id="sidebarDashboards">
                                <ul class="nav-second-level">
                                    ...
                                    <li>
                                        <router-link to='/dashboard3'>Dashboard 3</router-link>
                                       
                                    </li>
                                    <li>
                                        <router-link to='/dashboard4'>Dashboard 4</router-link>
                        ...
                        <!-- <li class="menu-title mt-2">System Setup</li> -->
                        <li>
                        ...
                        <li>
                            <router-link to='/setup/warehouse'>
                                <i data-feather="home"></i>
                        ...
                        <li>
                            <router-link to='/setup/warehouse-mapping'>
                                <i data-feather="home"></i>
                                <span> Warehouse In-Charge </span>
                            </router-link>
                        </li>
                        
                        <li>
                            <router-link to='/setup/warehouse-room'>
                                <i data-feather="home"></i>
                                <span> Warehouse Room </span>
                            </router-link>
                        </li>
                        <li>
                            <router-link to='/setup/rack'>
                                <i data-feather="home"></i>
                        ...
                        <li>
                            <router-link to='/setup/workflow-team'>
                                <i data-feather="home"></i>
                        ...
                        <li>
                            <router-link to='/setup/previous-data'>
                                <i data-feather="calendar"></i>
                                <span> Previous Data Entry </span>
                            </router-link>
                        </li>
                        <li>
                            <router-link to='/setup/previous-data-processed'>
                                <i data-feather="calendar"></i>
                                <span> Processed Pre. Data</span>
                            </router-link>
                        </li>
                                    <!-- <li>
